...
import {useSalesFriendsOpen} from "@/hooks/toggler";

export default function salesFriends() {
    const open = useSalesFriendsOpen(true);

    if (!open) return null;

    return (
        <div className="flex-col w-[375px] h-[207px] mx-auto items-center justify-center-safe bg-white">
